...
\ufopthesis{
    ...
    portuguesetitle={A evolução de softwares livres},
    portuguesebrokentitle={A evolução de softwares livres},
    portuguesecourse={Bacharelado em Ciência da Computação},
    portugueseshortcourse={Ciência da Computação},
    address={Ouro Preto},
    date={2017-07}, % ano-mês
    logo={brasao},
...
%escolher um dos estilos abaixo (ou outro) que preferir para citaÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµes. 
